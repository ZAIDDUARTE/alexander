...
export default function Section4ReviewPage() {
  ...
  useEffect(() => {
    setNavigation({ stage: "section-review", sectionId: 4 });
  }, [setNavigation]);
  ...
  return (
    ...
    >
      ...
      <Section4Form mode="review" />
      <div className="mt-6 flex flex-col gap-3 sm:flex-row">
        <SecondaryButton
          className="sm:flex-1"
          onClick={() => router.push("/onboarding/sections/4/complete")}
        >
          Back to completion
        </SecondaryButton>
        <PrimaryButton className="sm:flex-1" onClick={() => router.push("/onboarding/sections/4/form")}>
          Edit in full form →
        </PrimaryButton>
      </div>
    </OnboardingShell>
